...
**Try it** (needs Node.js 20+, the Stellar CLI, and a Rust toolchain). Generate and fund a testnet account, deploy the contract, then walk a full send → scan → claim cycle with the CLI on Stellar **testnet**:
